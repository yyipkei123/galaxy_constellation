...
export function ChatAssistantPanel({ context, onClose }: ChatAssistantPanelProps) {
  ...
  return (
    <section
      ...
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+5rem)] right-4 z-50 flex max-h-[min(42rem,calc(100vh-7rem))] w-[min(calc(100vw-2rem),26rem)] flex-col overflow-hidden rounded-lg border border-galaxy-border bg-galaxy-ink/96 shadow-2xl shadow-black/45 backdrop-blur sm:right-6"
    >
