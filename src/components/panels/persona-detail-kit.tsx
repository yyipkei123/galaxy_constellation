...
export function PersonaDetailKit({ persona }: { persona: SegmentPersona }) {
  ...
  return (
    <section aria-label="Persona recommendation kit">
      <Panel className="space-y-6 border-galaxy-gold/30 bg-[linear-gradient(135deg,rgba(205,164,92,0.12),rgba(12,23,35,0.78))]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h3 className="mt-3 font-serif text-3xl text-galaxy-cream">{persona.name}</h3>
        ...
        {primaryRecommendation ? (
          ...
          <section className="rounded-lg border border-galaxy-border bg-galaxy-ink/35 p-5">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-galaxy-gold">
              Activation handoff
            </p>
            <p className="mt-3 text-sm leading-6 text-galaxy-muted">
              No persona recommendation is available for this audience.
            </p>
          </section>
        )}
      </Panel>
